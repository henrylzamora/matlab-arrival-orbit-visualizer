function [coe,r_vec_SOI_Entry_a_I, RA_Entry_a, DEC_Entry_a]  = func_copy_MAIN_Planetary_Approach_RevC(v_inf_Entry_I,zp,var,Primary,input)
% Choose between:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %% INPUTS
% Primary.Name  = 'Jupiter';   % Planet
% v_inf_Entry_I = [-10;-1;-6]; %[km/s] Excess Velocity Vector at SOI Entrance in Inertial, Planetocentric Coordinates
% zp = 1000;                   %[km] Altitude at periapsis
